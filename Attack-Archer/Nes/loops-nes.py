...
class TestLoop(BaseLoop):
    ...
    def run_iter(self, idx, data_batch: Sequence[dict],modelname) -> None:
        ...
        from attacker.nes_attacker import NESAttack 
        attacker = NESAttack(epsilon=8,lr=2.55, q=1,fd_eta = 2.55,p="inf",name = "NES"
                             , max_loss_queries=10000,batch_size =1,lb = 0,ub=255)
