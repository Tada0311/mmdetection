...
class TestLoop(BaseLoop):
    ...
    def run_iter(self, idx, data_batch: Sequence[dict]) -> None:
        ...
        '''
        # data_batch = attacker.initialize_noise()    
        ...
        bgr_tensor = data_batch['inputs'][0]
        rgb_tensor = bgr_tensor[[2, 1, 0], :, :]
        to_pil = ToPILImage()
        ...
        for i in range(1, 11):
            if i == 1:
                ...
                data_batch = attacker.search_noise()
            ...
            if i == 1 or mean_ap < mean_ap_worst:
                outputs_worst = outputs
                data_batch_worst = data_batch
