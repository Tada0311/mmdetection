...
class TestLoop(BaseLoop):
    ...
    def run_iter(self, idx, data_batch: Sequence[dict]) -> None:
        ...
        sys.path.append("C:\\Users\\19187\\Code\\Python\\Project\\Attack\\mmdetection")
        sys.path.append("C:\\Users\\19187\\Code\\Python\\Project\\Attack\\mmdetection\\BlackboxBench-main\\query")
        ...
        from attacker.bandit_attack import BanditAttack 
        attacker = BanditAttack(batch_size=1, name="Bandit", epsilon=8, p="inf", 
                                lr=2.55, fd_eta=2.55, prior_lr=0.1, prior_size=20,
                                data_size=32, prior_exploration=0.1, max_loss_queries=10000,
                                lb=0, ub=255)
